...
- (void)configurePurpleAccount
{
	...
	NSString *protocolVersion = [self preferenceForKey:PROT_VER_NSSTRING group:GROUP_ACCOUNT_STATUS];
	int protocolInt = [protocolVersion intValue];
	purple_account_set_int(self.purpleAccount,PROT_VER_STRING, protocolInt);
	
	NSString *masterServer = [self preferenceForKey:KEY_MASTER_SERVER group:GROUP_ACCOUNT_STATUS];
	purple_account_set_string(self.purpleAccount, KEY_MASTER_SERVER_HON, [masterServer UTF8String]);
}
